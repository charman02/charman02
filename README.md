...
**67 REST endpoints · 18 data models · 1,830 automated tests (848 pytest + 982 Vitest) · 366 commits over 4 months, solo**
...
the app. Four of the eighteen are backend tests, covering the three surfaces no
rendered-screen assertion can reach: a push body, an unfurl card, a web manifest.
...
|---|---|---|---|
| **[issei](https://github.com/charman02/issei)** | Recipe app for dishes nobody wrote down — deployed, capability-token sharing, three visibility tiers, blocking + reporting, Web Push from scratch | 67 endpoints · 1,830 tests | FastAPI · React · Postgres · AWS |
