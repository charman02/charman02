...
**67 REST endpoints · 18 data models · 1,872 automated tests (890 pytest + 982 Vitest) · 368 commits over 4 months, solo**
...
|---|---|---|---|
| **[issei](https://github.com/charman02/issei)** | Recipe app for dishes nobody wrote down — deployed, capability-token sharing, three visibility tiers, blocking + reporting, Web Push from scratch | 67 endpoints · 1,872 tests | FastAPI · React · Postgres · AWS |
